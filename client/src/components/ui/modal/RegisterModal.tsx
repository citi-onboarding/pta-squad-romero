...
export function RegisterModal() {
  ...
  return (
    <Dialog>
      <DialogTrigger asChild> {/* the button that triggers the appearance of the modal */}
        <Button variant="outline" className="w-[205px] h-12 rounded-3xl bg-[#50E678]  shadow-md">Finalizar Cadastro</Button>
      </DialogTrigger>
